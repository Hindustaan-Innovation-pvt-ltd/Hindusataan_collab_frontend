...
export type Base = { id: string; x: number; y: number; locked?: boolean; isSticker?: boolean; w?: number; h?: number };

export type StickyEl = Base & { type: "sticky"; w: number; h: number; text: string; color: string; textColor?: string };
...
export type FreeArrowEl = Base & { type: "free_arrow"; dx: number; dy: number; color: string; sw?: number; dash?: string; arrowHead?: boolean; routing?: "straight" | "elbow" | "curved"; bend?: { ratio: number, offset: number }; from?: string; to?: string };

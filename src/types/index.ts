...
export type ShapeEl = Base & { type: "shape"; kind: ShapeKind; w: number; h: number; color: string };
...
export type El = StickyEl | TextEl | ShapeEl | PathEl | ConnectionEl | TableEl | FreeArrowEl;

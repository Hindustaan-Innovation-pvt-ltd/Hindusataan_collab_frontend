...
export const STICKY_TEXT_COLORS = ["#1E293B", "#000000", "#FFFFFF", "#FF4757", "#1E90FF", "#2ED573", "#5F27CD", "#D980FA", "#FF9F43", "#0ABDE3"];
...
export const ARROW_COLORS = [
  "#6B7280", "var(--color-foreground)", "#000000", "#FFFFFF", "#FF4757", "#2ED573", "#1E90FF", "#FFE566", "#FF6B9D",
